...
!(function () {
    ...
    updateSize: function () {
      ...
      ((t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth),
        ...
        (0 === t && e.isHorizontal()) ||
          (0 === s && e.isVertical()) ||
          ((t =
            t - parseInt(b(i, 'padding-left') || 0, 10) - parseInt(b(i, 'padding-right') || 0, 10)),
          (s =
            s - parseInt(b(i, 'padding-top') || 0, 10) - parseInt(b(i, 'padding-bottom') || 0, 10)),
          Number.isNaN(t) && (t = 0),
          Number.isNaN(s) && (s = 0),
      ...
      if (((p = i && e > o ? o : i && e < d ? d : e), r.updateProgress(p), n.cssMode)) {
        ...
        if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -p;
          ...
          if (!r.support.smoothScroll)
            return (m({ swiper: r, targetPosition: -p, side: e ? 'left' : 'top' }), !0);
  ...
  var Y = {
    ...
    slideReset: function (e, t, s) {
      ...
      const i = this;
      if (!i.destroyed)
        return (void 0 === e && (e = i.params.speed), i.slideTo(i.activeIndex, e, t, s));
    },
    ...
    slideToClickedSlide: function () {
      ...
      if (t.loop) {
        ...
        ((a = parseInt(e.clickedSlide.getAttribute('data-swiper-slide-index'), 10)),
          t.centeredSlides
            ? e.slideToLoop(a)
            : r > (o ? (e.slides.length - i) / 2 - (e.params.grid.rows - 1) : e.slides.length - i)
              ? (e.loopFix(),
  ...
  var H = {
    ...
    loopFix: function (e) {
      ...
      const { slides: p, allowSlidePrev: c, allowSlideNext: u, slidesEl: m, params: h } = d,
      ...
      void 0 === r
        ? (r = d.getSlideIndex(p.find((e) => e.classList.contains(h.slideActiveClass))))
        : (C = r);
      const P = 'next' === i || !i,
        L = 'prev' === i || !i;
      let z = 0,
      ...
      if (A < y) {
        ...
        ((k = Math.max(A - (T - 2 * y), b)), M && (k = Math.max(k, w - T + v + 1)));
        for (let e = 0; e < k; e += 1) {
          const t = e - Math.floor(e / T) * T;
          x
            ? p.forEach((e, s) => {
      ...
      if (
        ...
        'cards' === d.params.effect &&
          p.length < w + 2 * y &&
          (S.includes(r) && S.splice(S.indexOf(r), 1), E.includes(r) && E.splice(E.indexOf(r), 1)),
        L &&
          E.forEach((e) => {
      ...
      if (
        ((d.allowSlidePrev = c), (d.allowSlideNext = u), d.controller && d.controller.control && !l)
      ) {
        const e = {
          slideRealIndex: t,
          direction: i,
  ...
  function q(e, t, s) {
    ...
    return (
      !n || !(s <= l || s >= i.innerWidth - l) || ('prevent' === n && (t.preventDefault(), !0))
    );
  }
  function F(e) {
    const t = this,
  ...
  function V(e) {
    ...
    if (
      ...
      void 0 === a.startMoving &&
        ((n.currentX === n.startX && n.currentY === n.startY) || (a.startMoving = !0)),
  ...
  function j(e) {
    ...
    if (
      (s.allowTouchCallbacks && t.emit('touchEnd', a), (s.allowTouchCallbacks = !1), !s.isTouched)
    )
      return (
  ...
  const ie = {
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const l = i(),
            o =
              'window' !== a.breakpointsBase && a.breakpointsBase ? 'container' : a.breakpointsBase,
            d =
    ...
    slidesPerViewDynamic(e, t) {
      ...
      if (s.centeredSlides) {
        ...
        for (let s = l - 1; s >= 0; s -= 1)
          i[s] && !e && ((t += i[s].swiperSlideSize), (o += 1), t > n && (e = !0));
      } else if ('current' === e)
  ...
  const ve = [
      ...
      function g(e) {
        ...
        if (
          ...
          if (
            (u.push(s),
            i
              ? (s.direction !== i.direction || s.delta > i.delta || s.time > i.time + 150) && f(s)
              : f(s),
            (function (e) {
      ...
      function c() {
        ...
        p.forEach((e, r) => {
          ...
          ('custom' === s.type && s.renderCustom
            ? (C(e, s.renderCustom(t, i + 1, u)), 0 === r && a('paginationRender', e))
      ...
      function u() {
        ...
        ('fraction' === e.type &&
          ...
          i.forEach((s) => {
            ('custom' !== e.type && C(s, r || ''),
              'bullets' === e.type &&
                t.pagination.bullets.push(...s.querySelectorAll(le(e.bulletClass))));
          }),
    ...
    function (e) {
      ...
      function x(e) {
        ...
        let r;
        ((r =
          (y(e) - w(a)[t.isHorizontal() ? 'left' : 'top'] - (null !== d ? d : p / 2)) / (c - p)),
      ...
      function M(e) {
        ...
        m &&
          ((m = !1),
          t.params.cssMode &&
            ((t.wrapperEl.style['scroll-snap-type'] = ''), (a.style.transitionDuration = '')),
          s.hide &&
            (clearTimeout(f),
            (f = l(() => {
    ...
    function (e) {
        ...
        ((s.scale = A || I),
          ...
          !e || (1 === l && A)
            ...
            : ((L = v.slideEl.offsetWidth),
              ...
              (C = -S),
              (P = -T),
              k > 0 && A && 'number' == typeof b.currentX && 'number' == typeof b.currentY
      ...
      function _() {
        ...
        v.imageEl &&
          ...
          t.params.zoom.panOnMouseMove &&
            ((c = { x: 0, y: 0 }), p && ((p = !1), (b.startX = 0), (b.startY = 0))));
      }
      function G(e) {
        const s = t.zoom;
      ...
      (Object.defineProperty(t.zoom, 'scale', {
        ...
        Object.assign(t.zoom, { enable: X, disable: N, in: D, out: _, toggle: G }));
    },
    function (e) {
      let { swiper: t, extendParams: s, on: i } = e;
      function a(e, t) {
              ...
              if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                ...
                if (r.freeMode.momentum) {
                  ...
                  if (c < t.maxTranslate())
                    ...
                    ((c =
                      Math.abs(d[e] - c) < Math.abs(d[e - 1] - c) || 'next' === t.swipeDirection
                        ? d[e]
                        : d[e - 1]),
                      (c = -c));
                  }
  ...
  function Te(e, t, s) {
    ...
    return (
      'string' == typeof t && void 0 !== s && l.push({ name: t, value: be(s) ? { ...s } : s }),
      l.forEach((e) => {
  ...
  class ze extends Ce {
    ...
    static get prevButtonSvg() {
      return Pe.replace('/></svg>', ' transform-origin="center" transform="rotate(180)"/></svg>');
    }
    cssStyles() {
      return [
        Me,
    ...
    attributeChangedCallback(e, t, s) {
      this.swiper &&
        this.swiper.initialized &&
        ('true' === t && null === s && (s = !1), this.updateSwiperOnPropChange(e, s));
    }
  ...
  class ke extends Ce {
    ...
    render() {
      const e =
        this.lazy || '' === this.getAttribute('lazy') || 'true' === this.getAttribute('lazy');
      if (
        (Le(
          this.shadowRoot,
